module.exports = function(Ext) {
    ...
    XTemplateCompiler.prototype.useFormat = true;
        
    XTemplateCompiler.prototype.propNameRe = /^[\w\d\$]*$/;
    ...
    XTemplateCompiler.prototype.generate = function (tpl) {
        var me = this,
    ...
    XTemplateCompiler.prototype.doText = function (text) {
        var me = this,
            out = me.body;
    ...
    XTemplateCompiler.prototype.doExpr = function (expr) {
        var out = this.body;
    ...
    XTemplateCompiler.prototype.doTag = function (tag) {
    ...
    XTemplateCompiler.prototype.doElse = function () {
        this.body.push('} else {\n');
    };

    XTemplateCompiler.prototype.doEval = function (text) {
        this.body.push(text, '\n');
    };

    XTemplateCompiler.prototype.doIf = function (action, actions) {
        var me = this;
    ...
    XTemplateCompiler.prototype.doElseIf = function (action, actions) {
        var me = this;
    ...
    XTemplateCompiler.prototype.doSwitch = function (action) {
        var me = this;
    ...
    XTemplateCompiler.prototype.doCase = function (action) {
        var me = this,
    ...
    XTemplateCompiler.prototype.doDefault = function () {
        var me = this,
            n = me.switches.length - 1;
    ...
    XTemplateCompiler.prototype.doEnd = function (type, actions) {
        var me = this,
            L = me.level-1;
    ...
    XTemplateCompiler.prototype.doFor = function (action, actions) {
        var me = this,
            s,
            L = me.level,
            up = L-1,
    ...
    XTemplateCompiler.prototype.doForEach = function (action, actions) {
        var me = this,
            s,
            L = me.level,
            up = L-1,
    ...
    XTemplateCompiler.prototype.createArrayTest = ('isArray' in Array) ? function(L) {
        return 'Array.isArray(c' + L + ')';
    } : function(L) {
        return 'ts.call(c' + L + ')==="[object Array]"';
    };

    XTemplateCompiler.prototype.doExec = function (action, actions) {
        var me = this,
    ...
    XTemplateCompiler.prototype.addFn = function (body) {
        var me = this,
            name = 'f' + me.definitions.length;
    ...
    XTemplateCompiler.prototype.parseTag = function (tag) {
        var me = this,
            m = me.tagRe.exec(tag),
    ...
    // @private
    XTemplateCompiler.prototype.evalTpl = function ($) {
    ...
    XTemplateCompiler.prototype.newLineRe = /\r\n|\r|\n/g;
