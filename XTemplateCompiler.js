var Ext             = require('./Ext');
Ext.XTemplateParser = require('./XTemplateParser');
// @tag core
/**
...
Ext.XTemplateParser.prototype.useFormat = true;
    
Ext.XTemplateParser.prototype.propNameRe = /^[\w\d\$]*$/;

Ext.XTemplateParser.prototype.compile = function (tpl) {
    var me = this,
...
Ext.XTemplateParser.prototype.generate = function (tpl) {
    var me = this,
...
Ext.XTemplateParser.prototype.doText = function (text) {
    var me = this,
        out = me.body;
...
Ext.XTemplateParser.prototype.doExpr = function (expr) {
    var out = this.body;
...
Ext.XTemplateParser.prototype.doTag = function (tag) {
...
Ext.XTemplateParser.prototype.doElse = function () {
    this.body.push('} else {\n');
};

Ext.XTemplateParser.prototype.doEval = function (text) {
    this.body.push(text, '\n');
};

Ext.XTemplateParser.prototype.doIf = function (action, actions) {
    var me = this;
...
Ext.XTemplateParser.prototype.doElseIf = function (action, actions) {
    var me = this;
...
Ext.XTemplateParser.prototype.doSwitch = function (action) {
    var me = this;
...
Ext.XTemplateParser.prototype.doCase = function (action) {
    var me = this,
...
Ext.XTemplateParser.prototype.doDefault = function () {
    var me = this,
        n = me.switches.length - 1;
...
Ext.XTemplateParser.prototype.doEnd = function (type, actions) {
    var me = this,
        L = me.level-1;
...
Ext.XTemplateParser.prototype.doFor = function (action, actions) {
    var me = this,
        s,
        L = me.level,
        up = L-1,
...
Ext.XTemplateParser.prototype.doForEach = function (action, actions) {
    var me = this,
        s,
        L = me.level,
        up = L-1,
...
Ext.XTemplateParser.prototype.createArrayTest = ('isArray' in Array) ? function(L) {
    return 'Array.isArray(c' + L + ')';
} : function(L) {
    return 'ts.call(c' + L + ')==="[object Array]"';
};

Ext.XTemplateParser.prototype.doExec = function (action, actions) {
    var me = this,
...
Ext.XTemplateParser.prototype.addFn = function (body) {
    var me = this,
        name = 'f' + me.definitions.length;
...
Ext.XTemplateParser.prototype.parseTag = function (tag) {
    var me = this,
        m = me.tagRe.exec(tag),
...
// @private
Ext.XTemplateParser.prototype.evalTpl = function ($) {
...
Ext.XTemplateParser.prototype.newLineRe = /\r\n|\r|\n/g;
Ext.XTemplateParser.prototype.aposRe = /[']/g;
Ext.XTemplateParser.prototype.intRe =  /^\s*(\d+)\s*$/;
Ext.XTemplateParser.prototype.tagRe =  /^([\w-\.\#\$]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?(\s?[\+\-\*\/]\s?[\d\.\+\-\*\/\(\)]+)?$/;

module.exports = Ext.XTemplateParser;