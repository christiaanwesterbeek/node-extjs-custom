var Ext         = require('./Ext');
Ext.util.Format = require('./util/Format');
/**
...
Ext.Template = function(html) {
     ...
     */
    this.applyOut = function(values, out) {
        var me = this;
     ...
     */
    this.set = function(html, compile) {
        var me = this;
        me.html = html;
        me.compiled = null;
     ...
     */
    this.insertFirst = function(el, values, returnElement) {
     ...
     * @return {HTMLElement/Ext.Element} The new node or Element
     */
    this.insertBefore = function(el, values, returnElement) {
     ...
     * @return {HTMLElement/Ext.Element} The new node or Element
     */
    this.insertAfter = function(el, values, returnElement) {
     ...
     * @return {HTMLElement/Ext.Element} The new node or Element
     */
    this.append = function(el, values, returnElement) {
        return this.doInsert('beforeEnd', el, values, returnElement);
    },

    this.doInsert = function(where, el, values, returnElement) {
     ...
     * @return {HTMLElement/Ext.Element} The new node or Element
     */
    this.overwrite = function(el, values, returnElement) {
