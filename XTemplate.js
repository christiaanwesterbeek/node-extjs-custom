...
Ext.XTemplateCompiler = require('./XTemplateCompiler');
 ...
 * @private
 */
Ext.Template.prototype.emptyObj = {};
...
Ext.Template.prototype.apply = function(values, parent) {
    return this.applyOut(values, [], parent).join('');
},

Ext.Template.prototype.applyOut = function(values, out, parent) {
    var me = this,
        compiler;
...
Ext.Template.prototype.statics = {
    /**
