module.exports = function(Ext) {
     ...
     * @private
     */
    var XTemplateParser = function(config) {
    };

    XTemplateParser.prototype.className = 'Ext.XTemplateParser';
     ...
     * @method
     */
    XTemplateParser.prototype.doTpl = function () {}, //Ext.emptyFn,

    XTemplateParser.prototype.parse = function (str) {
        var me = this,
            len = str.length,
            aliases = { elseif: 'elif' },
            topRe = me.topRe,
    ...
    XTemplateParser.prototype.topRe =     /(?:(\{\%)|(\{\[)|\{([^{}]+)\})|(?:<tpl([^>]*)\>)|(?:<\/tpl>)/g,
    XTemplateParser.prototype.actionsRe = /\s*(elif|elseif|if|for|foreach|exec|switch|case|eval|between)\s*\=\s*(?:(?:"([^"]*)")|(?:'([^']*)'))\s*/g,
    XTemplateParser.prototype.propRe =    /prop=(?:(?:"([^"]*)")|(?:'([^']*)'))/,
    XTemplateParser.prototype.defaultRe = /^\s*default\s*$/,
    XTemplateParser.prototype.elseRe =    /^\s*else\s*$/
